  ...
  <section id="contact" className="section-padding">
    <div className="container mx-auto">
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
        <span className="text-gold font-body text-sm font-semibold tracking-widest uppercase mb-4 block">Get In Touch</span>
        <h2 className="text-3xl md:text-5xl font-bold">Visit <span className="text-gold-gradient">Our Clinic</span></h2>
      </motion.div>
        ...
        <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="space-y-8">
          {[
            ...
            <div key={item.label} className="flex gap-4 items-start">
              ...
              <div>
                <div className="font-semibold text-sm font-body mb-1">{item.label}</div>
